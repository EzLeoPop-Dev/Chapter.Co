  ...
  return (
    <div className="min-h-screen flex bg-[#f7f7f4] text-[#26251e] selection:bg-[#f54e00] selection:text-white font-[-apple-system,BlinkMacSystemFont,'Inter','Segoe_UI',Roboto,sans-serif]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 md:p-8 relative overflow-hidden">
        ...
        <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-orange-300 rounded-full mix-blend-multiply filter blur-[128px] opacity-30 animate-blob"></div>
        <div className="absolute bottom-[20%] left-[-5%] w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 animate-blob animation-delay-2000"></div>
        ...
        <div className="w-full max-w-md backdrop-blur-xl bg-white/40 border border-white/60 rounded-[2.5rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-[32px] font-normal tracking-[-0.64px] text-[#26251e] mb-2">Create an Account</h1>
            <p className="text-[#5a5852]">Join Chapter.Co today</p>
          </div>

          <form className="space-y-5">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-[#5a5852] mb-1">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-[#5a5852] mb-1">
                Password
              </label>
              <input
                id="password"
            ...
            <button
              type="submit"
              className="w-full py-3.5 px-4 mt-4 rounded-2xl bg-gradient-to-r from-orange-500 to-amber-500 text-white font-medium hover:shadow-lg hover:shadow-orange-500/30 hover:-translate-y-0.5 transition-all duration-300"
            >
              Sign Up
            </button>
          </form>
          ...
          <p className="mt-8 text-center text-sm text-[#5a5852]">
            ...
            <Link href="/auth/login" className="font-medium text-[#f54e00] hover:text-orange-600 transition-colors">
              Sign in
            </Link>
          </p>
        </div>
