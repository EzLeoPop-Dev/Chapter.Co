  ...
  return (
    <div className="min-h-screen flex bg-[#f7f7f4] text-[#26251e] selection:bg-[#f54e00] selection:text-white font-[-apple-system,BlinkMacSystemFont,'Inter','Segoe_UI',Roboto,sans-serif]">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 md:p-8 relative overflow-hidden">
        ...
        <div className="absolute top-[-5%] left-[10%] w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-[128px] opacity-30 animate-blob"></div>
        <div className="absolute bottom-[10%] right-[-10%] w-96 h-96 bg-orange-300 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 animate-blob animation-delay-2000"></div>
        ...
        <div className="w-full max-w-md backdrop-blur-xl bg-white/40 border border-white/60 rounded-[2.5rem] p-10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-[32px] font-normal tracking-[-0.64px] text-[#26251e] mb-2">Reset Password</h1>
            <p className="text-[#5a5852] text-sm">Enter your email and we'll send you a link to reset your password.</p>
          </div>
