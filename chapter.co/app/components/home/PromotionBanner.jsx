...
export default function PromotionBanner() {
  return (
    <section className="mb-16">
      <div className="backdrop-blur-md bg-gradient-to-r from-orange-400 to-amber-500 border border-white/40 rounded-[2.5rem] p-8 md:p-12 shadow-[0_8px_30px_rgb(249,115,22,0.2)] flex flex-col md:flex-row items-center justify-between relative overflow-hidden">
        ...
        <button className="relative z-10 bg-white text-[#f54e00] px-8 py-3.5 rounded-2xl text-[14px] font-medium hover:shadow-lg hover:scale-105 transition-all duration-300 whitespace-nowrap">
          ดูโปรโมชั่นทั้งหมด
        </button>
      </div>
    </section>
