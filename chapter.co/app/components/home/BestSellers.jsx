    ...
    <section className="mb-16">
      <div className="mb-8 flex items-center justify-between">
        <div className="flex items-center">
          <h2 className="text-[36px] font-normal tracking-[-0.72px] text-[#26251e] mr-4">หนังสือขายดีอันดับ 1</h2>
          ...
          <div key={book.id} className="group cursor-pointer">
            ...
            <div className="px-2">
              <div className="flex items-center text-[13px] text-[#807d72] mb-2">
                ...
                <span className="font-semibold text-[#26251e] mr-1.5">{book.rating}</span>
                <span className="font-normal">{book.reviews} reviews</span>
              </div>
              <h3 className="font-semibold text-[18px] text-[#26251e] mb-1 group-hover:text-[#f54e00] transition-colors line-clamp-1">{book.title.replace('\n', ' ')}</h3>
              <p className="text-[16px] text-[#5a5852] mb-4 font-normal">{book.author}</p>

              <div className="flex justify-between items-center">
                <span className="text-[22px] font-normal tracking-[-0.11px] text-[#26251e]">${book.price}</span>
