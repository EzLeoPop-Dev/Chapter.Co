  ...
  return (
    <section className="backdrop-blur-xl bg-white/40 border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.06)] rounded-[2.5rem] p-10 lg:p-16 flex flex-col md:flex-row items-center justify-between mb-12">
      <div className="max-w-lg mb-10 md:mb-0">
        <div className="inline-block px-4 py-1.5 rounded-full bg-orange-100/80 text-[#f54e00] text-[11px] font-semibold tracking-[0.88px] uppercase mb-6 border border-orange-200/50">
          AI-POWERED CURATION
        </div>
        <h1 className="text-[56px] lg:text-[72px] font-normal tracking-[-2.16px] leading-[1.1] mb-6 text-[#26251e]">
        ...
        <p className="text-[#5a5852] text-[16px] mb-8 leading-[1.5] font-normal">
        ...
        <div className="flex space-x-4">
          <button className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-8 py-3.5 rounded-2xl text-[14px] font-medium hover:shadow-lg hover:shadow-orange-500/30 hover:-translate-y-0.5 transition-all duration-300">
            Start Exploring
          </button>
          <button className="bg-white/60 backdrop-blur-sm border border-white text-[#26251e] px-8 py-3.5 rounded-2xl text-[14px] font-medium hover:bg-white hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
            View Curations
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex items-center space-x-3 backdrop-blur-md bg-white/40 px-4 py-2 rounded-2xl border border-white/50 shadow-sm">
          <button className="p-1.5 text-[#a09c92] hover:text-[#26251e] hover:bg-white/60 rounded-full transition-colors">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M15 18l-6-6 6-6" /></svg>
          </button>
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="w-12 h-16 bg-[#e6e5e0] border-2 border-transparent hover:border-orange-400 cursor-pointer rounded-lg overflow-hidden transition-all hover:shadow-md hover:-translate-y-1">
