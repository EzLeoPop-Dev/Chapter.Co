        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between">
            <div>
                <div className="flex items-center mb-2">
                    ...
                    <div className="hidden sm:block w-32 h-px bg-gradient-to-r from-primary to-transparent"></div>
                </div>
                {subtitle && <p className="text-sm text-slate-500 font-light">{subtitle}</p>}
            </div>
            <button className="text-sm font-semibold text-primary hover:text-primary mt-2 md:mt-0 flex items-center group transition-colors">
                ดูทั้งหมด
