            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-between">
                ...
                <div className="flex justify-between items-center mt-6 pt-4 border-t border-[#e6e5e0]">
                  ...
                  <div className="w-10 h-10 rounded-full bg-[#F2EEE7] flex items-center justify-center text-[#1A1A1A] group-hover:bg-primary group-hover:text-white transition-colors">
