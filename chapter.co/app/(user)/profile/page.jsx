          ...
          <aside className="w-full md:w-64 flex-shrink-0">
            <div className="bg-white/70 backdrop-blur-xl border border-white/80 rounded-[2rem] shadow-sm p-4 sticky top-8">
              ...
              <ul className="space-y-2 font-bold text-sm">
                <li><Link href="/profile" className="block px-4 py-3 rounded-xl bg-orange-50 text-orange-600 transition-colors">ข้อมูลส่วนตัว</Link></li>
          ...
          <div className="flex-1">
            <div className="bg-white/70 backdrop-blur-xl border border-white/80 rounded-[2.5rem] p-8 md:p-12 shadow-sm mb-8">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-black text-[#26251e]">ข้อมูลส่วนตัว</h2>
                <button className="px-5 py-2 bg-[#f7f7f4] hover:bg-[#e6e5e0] text-[#26251e] rounded-xl font-bold transition-colors shadow-sm text-sm">
                  แก้ไขข้อมูล
                </button>
              </div>
            ...
            <div className="bg-white/70 backdrop-blur-xl border border-white/80 rounded-[2.5rem] p-8 md:p-12 shadow-sm">
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-xl font-bold text-[#26251e]">ที่อยู่จัดส่งเริ่มต้น</h2>
                <button className="text-orange-500 font-bold hover:text-orange-600 text-sm">จัดการที่อยู่ทั้งหมด</button>
              </div>
              <div className="border border-[#e6e5e0] bg-white rounded-2xl p-6">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="font-bold text-lg">บ้าน</h3>
                  <span className="px-2 py-1 bg-orange-100 text-orange-600 text-[10px] font-bold uppercase rounded-md">ค่าเริ่มต้น</span>
                </div>
                <p className="text-[#5a5852] font-medium leading-relaxed mt-2">
