...
2. เพื่อออกแบบและพัฒนาผู้ใช้งาน ให้มีความทันสมัย ใช้งานง่าย ค้นหาหนังสือได้สะดวกรวดเร็ว และสบายตา เเละทำส่วนของ Admin ให้จัดการสินค้าได้ง่าย
...
* **Database:** `postgreSQL (Supabase)` (ใช้สำหรับจัดเก็บข้อมูล)
* **ORM:** `Prisma` (ใช้สำหรับการ QUERY ข้อมูลใน Database)
* **Auth:** `NextAuth` (ใช้สำหรับการจัดการ เข้าสู่ระบบ จัดการ Role ผู้ใช้งาน)
...
14. ระบบ Automation สำหรับกระบวนการทำงาน เช่น การยืนยันการชำระเงิน การเปลี่ยนสถานะคำสั่งซื้อ การตัดสต็อก การแจ้งเตือนลูกค้า และการสร้างใบจัดส่ง
...
**Bio**
บอสทำงานในฝ่ายคลังสินค้ามากว่า 2 ปี มีหน้าที่ตรวจสอบคำสั่งซื้อ แพ็กสินค้า และอัปเดตสถานะการจัดส่งให้ลูกค้าทุกวัน ในแต่ละวันเขาต้องจัดการคำสั่งซื้อจำนวนมาก จึงต้องการระบบที่ช่วยลดขั้นตอนการทำงานที่ซ้ำซ้อนและลดความผิดพลาดจากการทำงานด้วยมือ

**Goals**
- ตรวจสอบและอัปเดตสถานะคำสั่งซื้อได้อย่างรวดเร็วและถูกต้อง
- ลดความผิดพลาดในการตัดสต็อกสินค้า
- พิมพ์ใบจัดส่งและเพิ่มเลข Tracking ได้ในขั้นตอนเดียว
- ตรวจสอบผลการทำงานของระบบ Automation เพื่อยืนยันว่าไม่มีข้อผิดพลาด

**Pain Points**
- ระบบเดิมต้องอัปเดตสถานะคำสั่งซื้อด้วยมือ ทำให้เกิดความล่าช้าและผิดพลาดบ่อย
- การตรวจสอบสต็อกสินค้าระหว่างหน้าร้านและระบบออนไลน์ไม่เชื่อมโยงกัน
- ไม่มีระบบแจ้งเตือนเมื่อคำสั่งซื้อค้างนาน ทำให้บางออเดอร์ตกหล่น

**Scenario**
ทุกเช้าบอสจะเข้าสู่ระบบหลังบ้านของ Chapter.Co เพื่อตรวจสอบรายการคำสั่งซื้อใหม่ที่เข้ามาในคืนที่ผ่านมา ระบบ Automation ได้ยืนยันการชำระเงินและตัดสต็อกให้อัตโนมัติแล้ว บอสเพียงตรวจสอบความถูกต้อง แพ็กสินค้า จากนั้นเพิ่มเลข Tracking และพิมพ์ใบจัดส่งผ่านระบบ ก่อนอัปเดตสถานะคำสั่งซื้อเป็น "จัดส่งแล้ว" ซึ่งระบบจะแจ้งเตือนลูกค้าผ่านอีเมลโดยอัตโนมัติ
...
- ตรวจสอบการทำงานของระบบ Automation เพื่อให้มั่นใจว่าไม่มีข้อผิดพลาดกระทบต่อธุรกิจ
...
ศึกษาข้อมูลจาก ระบบ E-Commerce ที่ประสบความสำเร็จ
...
ออกแบบระบบให้ตรงกับความต้องการที่ได้จากการวิเคราะห์ ทั้งด้านโครงสร้างระบบ ฐานข้อมูล เเละ Ux/Ui
